...
/// Shared types, constants, and inline helpers for the nbody prediction service split files.
/// Used by service.cpp, prediction/trajectory.cpp, prediction/sampling.cpp, and policy files.
...
namespace Game
{
    ...
    // ── Trajectory helpers (prediction/trajectory.cpp) ───────────────────────
    ...
    // ── Sampling helpers (prediction/sampling.cpp) ───────────────────────────
    ...
    // ── Policy helpers (prediction/policy_*.cpp) ─────────────────────────────
    ...
    // ── Spacecraft route types (prediction/spacecraft.cpp)
    ...
    // ── Planned trajectory types (prediction/planned.cpp) ───────────────────
    ...
    // ── Planned trajectory helpers (prediction/planned.cpp) ─────────────────
